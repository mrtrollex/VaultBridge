...
# Current project state — `v1.2.0` prepared; publication pending
...
remains healthy. Application release `v1.2.0` is prepared but not tagged, published to GitHub/GHCR,
or delivered through the TrueNAS Community catalog. VB-082's remaining lifecycle gates stay open.
